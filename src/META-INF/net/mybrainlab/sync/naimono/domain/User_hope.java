...
public class User_hope implements Serializable {
    ...
    @Id
    @Column(name = "user_hope_id")
    private String user_hope_id;
    ...
    public User_hope(String user_hope_id, String user_id, String h_company_name, String place,
                     int income, int scale, int work, int industry, int h_job_category) {
        this.user_hope_id = user_hope_id;
